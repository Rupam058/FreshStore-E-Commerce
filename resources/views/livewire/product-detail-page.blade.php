         ...
         <div class="flex flex-wrap -mx-4">
            ...
            >
               <div class="sticky top-0 z-50 overflow-hidden ">
                  ...
                  <div class="flex-wrap hidden md:flex ">
                     ...
                     >
                        <img
                           src="https://m.media-amazon.com/images/I/61XPhYGQOQL._SX679_.jpg"
                           alt=""
                           class="object-cover w-full lg:h-20 cursor-pointer hover:border hover:border-blue-500"
                        >
                     </div>
                     ...
                     >
                        <img
                           src="https://m.media-amazon.com/images/I/81v5JNjZ4-L._SX679_.jpg"
                           alt=""
                           class="object-cover w-full lg:h-20 cursor-pointer hover:border hover:border-blue-500"
                        >
                     </div>
            ...
            <div class="w-full px-4 md:w-1/2 ">
               <div class="lg:pl-20">
                  <div class="mb-8 ">
                     <h2
                        class="max-w-xl mb-6 text-2xl font-bold dark:text-gray-400 md:text-4xl">
                        Macbook Pro M130c90</h2>
                     <p
                        class="inline-block mb-6 text-4xl font-bold text-gray-700 dark:text-gray-400 ">
                        <span>$1500.99</span>
                        <span
                     ...
                     <p class="max-w-md text-gray-700 dark:text-gray-400">
                        ...
                        elit. Soluta eligendi esse laboriosam ex hic magni
                        inventore dolores numquam, veniam totam ratione iusto
                        explicabo accusamus, sit alias, architecto voluptate
                        officiis quaerat?
                     </p>
                  </div>
                  <div class="w-32 mb-8 ">
                     ...
                     >Quantity</label>
                     <div
                        class="relative flex flex-row w-full h-10 mt-6 bg-transparent rounded-lg"
                     >
                        <button
