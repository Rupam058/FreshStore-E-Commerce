<div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
   <section class="flex items-center font-poppins dark:bg-gray-800 ">
      ...
      >
         <div>
            <h1
               class="px-4 mb-8 text-2xl font-semibold tracking-wide text-gray-700 dark:text-gray-300 ">
            ...
            >
               <div class="flex items-start justify-start flex-shrink-0">
                  <div
                     class="flex items-center justify-center w-full pb-6 space-x-4 md:justify-start"
                  >
                     <div
                     ...
                     >
                        <p
                           ...
                           Cielo Schimmel</p>
                        <p
                           class="text-sm leading-4 text-gray-600 dark:text-gray-400">
                           71582 Schmitt Springs</p>
                        <p
                           class="text-sm leading-4 text-gray-600 dark:text-gray-400">
                           Castro Valley, Delaware, 53476-0454</p>
                        <p
                           class="text-sm leading-4 cursor-pointer dark:text-gray-400">
                           Phone: 587-019-6103</p>
                     </div>
                  </div>
               </div>
            </div>
            <div
               class="flex flex-wrap items-center pb-4 mb-10 border-b border-gray-200 dark:border-gray-700"
            >
               <div class="w-full px-4 mb-4 md:w-1/4">
                  <p
                     class="mb-2 text-sm leading-5 text-gray-600 dark:text-gray-400 ">
                     Order Number: </p>
                  <p
                     class="text-base font-semibold leading-4 text-gray-800 dark:text-gray-400">
                     29</p>
               </div>
               <div class="w-full px-4 mb-4 md:w-1/4">
                  <p
               ...
               <div class="w-full px-4 mb-4 md:w-1/4">
                  <p
                     class="mb-2 text-sm font-medium leading-5 text-gray-800 dark:text-gray-400 ">
                     Total: </p>
                  <p
                     class="text-base font-semibold leading-4 text-blue-600 dark:text-gray-400">
                     ₹157,495.00</p>
               </div>
               <div class="w-full px-4 mb-4 md:w-1/4">
                  <p
                  ...
                  <div class="flex flex-col w-full space-y-6 ">
                     ...
                     >
                        <div class="flex justify-between w-full">
                           <p
                              class="text-base leading-4 text-gray-800 dark:text-gray-400">
                              Subtotal</p>
                           <p
                              class="text-base leading-4 text-gray-600 dark:text-gray-400">
                              ₹157,495.00</p>
                        </div>
                        ...
                        <div class="flex items-center justify-center space-x-2">
                           ...
                           <div
                              ...
                              <p
                                 ...
                                 Delivery<br><span
                                    class="text-sm font-normal">Delivery with 24
                                    Hours</span>
                              </p>
                           </div>
                        </div>
