<div>
   ...
   <div
      class="w-full h-screen bg-gradient-to-r from-blue-200 to-cyan-200 py-10 px-4 sm:px-6 lg:px-8 mx-auto"
   >
         ...
         >
            <div>
               <h1
                  ...
                  Start your journey with <span
                     class="text-blue-600">FreshStore</span></h1>
               <p class="mt-3 text-lg text-gray-800 dark:text-gray-400">Purchase
                  wide varities of electronics products like Smartphones,
                  Laptops, Smartwatches, Television and many more.</p>
      ...
      <div class="max-w-xl mx-auto">
         <div class="text-center ">
            <div class="relative flex flex-col items-center">
               <h1 class="text-5xl font-bold dark:text-gray-200"> Browse
                  Popular<span class="text-blue-500"> Brands
                  </span> </h1>
      ...
      <div class="justify-center max-w-6xl px-4 py-4 mx-auto lg:py-0">
         <div class="grid grid-cols-1 gap-6 lg:grid-cols-4 md:grid-cols-2">
            ...
            <div class="bg-white rounded-lg shadow-md dark:bg-gray-800">
               ...
               >
                  <img
                     src="https://i.pinimg.com/originals/a0/97/c3/a097c3c89b6d9a14f52f9515395d5220.png"
                     alt=""
            ...
            <div class="bg-white rounded-lg shadow-md dark:bg-gray-800">
               ...
               >
                  <img
                     src="https://salesindia.com/media/codazon_cache/brand/400x400/wysiwyg/codazon/main-content-22/Brand_logo/ONEPLUS_LOGO_.png"
                     alt=""
                     class="object-cover w-full h-64 rounded-t-lg"
                  >
               </a>
            ...
            <div class="bg-white rounded-lg shadow-md dark:bg-gray-800">
               ...
               >
                  <img
                     src="https://i.pinimg.com/originals/72/15/96/721596edd1de9db231a385d52a9081f8.png"
                     alt=""
                     class="object-cover w-full h-64 rounded-t-lg"
                  >
               </a>
   ...
   <section class="py-14 font-poppins dark:bg-gray-800">
      <div class="max-w-6xl px-4 py-6 mx-auto lg:py-4 md:px-6">
         <div class="max-w-xl mx-auto">
            <div class="text-center ">
               <div class="relative flex flex-col items-center">
                  <h1 class="text-5xl font-bold dark:text-gray-200"> Customer
                     <span class="text-blue-500"> Reviews
                     </span>
                  </h1>
                  <div class="flex w-40 mt-2 mb-6 overflow-hidden rounded">
                     <div class="flex-1 h-2 bg-blue-200">
         ...
         <div class="grid grid-cols-1 gap-6 lg:grid-cols-2 ">
            <div class="py-6 bg-white rounded-md shadow dark:bg-gray-900">
                  ...
                  <div class="flex items-center px-6 mb-2 md:mb-0 ">
                     ...
                     <div>
                        <h2
                           ...
                           Adren Roy</h2>
                        <p class="text-xs text-gray-500 dark:text-gray-400">Web
                           Designer</p>
                     </div>
                  </div>
                  <p
                     class="px-6 text-base font-medium text-gray-600 dark:text-gray-400">
                     Joined 12, SEP , 2022
                  </p>
               </div>
               ...
               <div
                  class="flex flex-wrap justify-between pt-4 border-t dark:border-gray-700"
               >
                  ...
                  >
                     <div class="flex items-center">
                        <div
                           class="flex mr-3 text-sm text-gray-700 dark:text-gray-400"
                        >
                           <a href="#">
                              <svg
                                 xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div
                           class="flex text-sm text-gray-700 dark:text-gray-400"
                        >
                           <a
                              href="#"
